...
// 创建订单 - 需要认证，应用订单速率限制
router.post('/create', authMiddleware, orderLimiter, orderController.createOrder);
...
// 支付订单 - 需要认证，应用支付速率限制
router.post('/pay/:orderId', authMiddleware, paymentLimiter, orderController.payOrder);
