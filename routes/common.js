...
const { validate, sendSmsCodeSchema } = require('../middleware/validationMiddleware');
...
// 发送验证码 - 应用短信发送速率限制
router.post('/sms/send', smsLimiter, validate(sendSmsCodeSchema), commonController.sendSmsCode);
